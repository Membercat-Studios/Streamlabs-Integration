...
import static com.membercat.streamlabs.config.issue.ConfigPathStack.getClassDisplayName;
import static com.membercat.streamlabs.config.issue.ConfigPathStack.getObjectTypeName;
...
public class Issues {
    ...
    public static ConfigIssue WI3 = new ConfigIssue("WI3", ConfigIssue.Level.WARNING);
    ...
    public static Function<String, ConfigIssue> WBS0 = behavior -> new ConfigIssue("WBS0", ConfigIssue.Level.WARNING, text(behavior));
    ...
    public static ConfigIssue WAC0 = new ConfigIssue("WAC0", ConfigIssue.Level.WARNING);
    ...
    public static ConfigIssue HC2 = new ConfigIssue("HC2", ConfigIssue.Level.HINT);
